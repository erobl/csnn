...
proportion = np.concatenate([proportion_train, proportion_valid], axis=0)
...
Xt = dataset_train.X.cpu().reshape((-1,11)).numpy()
Xt.shape, dy.shape
...
headers = ["FSC", "SSC", "CD66b", "CD22", "CD19", "CD24", "CD10", "CD34", "CD38", "CD20", "CD45", "Delta_Y_Delete", "Delta_Y_Upsample", "Tree_Label"]
