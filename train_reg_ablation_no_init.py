...
for seed in range(n_seeds):
    ...
    for params in tqdm(param_grid):
        ...
        resdir = "ablation_experiment/%s/models/seed_%d/hash_%d" % (config['experiment_name'], seed, param_hash)
        ...
        if True:
            ...
            model = ProportionPointSetNN(dataset_train.X.shape[-1], kwargs["architecture"])
