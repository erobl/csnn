...
from utils.trainer_cnn import train_initialize, load_evaluate
...
for seed in range(n_seeds):
    ...
    for params in tqdm(param_grid):
        ...
        hashparams['head_arch'] = frozenset(hashparams['head_arch'])
        ...
        if True:
            ...
            model, (preds_val, y_valid), (preds_train, y_train) = train_initialize(dataset_train, dataset_valid, **kwargs)
